---
name: pua
description: "Use when task fails 2+ times, passive behavior, or user frustration. Chinese PUA-style corporate pressure."
license: MIT
---
...
- `/pua_pro` — 自进化基线 + /pua 指令系统 + Compaction 保护
- `/pua_p9` — P9 Tech Lead 管理模式
- `/pua_p7` — P7 骨干执行模式
- `/pua_p10` — P10 CTO 战略模式
