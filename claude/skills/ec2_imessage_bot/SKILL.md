---
name: ec2_imessage_bot
version: 1.0.0
description: Use when managing the iMessage bot on EC2.
metadata:
  openclaw:
...
> **PREREQUISITE:** Read `../ec2_shared/SKILL.md` for SSH connection details and service management patterns.
