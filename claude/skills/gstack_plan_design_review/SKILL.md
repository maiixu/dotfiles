---
name: gstack_plan_design_review
version: 2.0.0
description: "Use when reviewing a plan's UI/UX design components."
allowed-tools:
  - Read
  - Edit
  - Grep
...
```bash
~/code/gstack/bin/gstack-review-log '{"skill":"plan-design-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"unresolved":N,"decisions_made":N,"commit":"COMMIT"}'
```
