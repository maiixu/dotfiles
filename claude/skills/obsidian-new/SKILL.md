...
- **Tags**: one or more relevant subject tag (see `obsidian-shared`); `#Meta--元数据/Source--来源/Claude-Code` is added by the script automatically.
...
```bash
~/code/dotfiles/claude/skills/obsidian-new/new.sh "{title}" "{body}" "{tags}"
```
