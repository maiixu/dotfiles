...
name: gws_calendar
version: 1.0.0
description: Use when managing Google Calendar calendars and events.
metadata:
  openclaw:
...
| Command | Description |
|---------|-------------|
| [`+insert`](../gws_calendar_insert/SKILL.md) | create a new event |
| [`+agenda`](../gws_calendar_agenda/SKILL.md) | Show upcoming events across all calendars |
...
### events
  ...
  - `import` — Imports an event (adds a private copy to a calendar).
